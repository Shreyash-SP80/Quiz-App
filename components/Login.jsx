...
const Login = ({onLoginSucess = null}) => {
  ...
  const handleSubmit = async (ev) => {
    ...
    // VALIDATE EMAIL AS WELL AS PASSWORD
    const validate = () => {
        const e = {};
  ...
  return (
    <div className={loginStyles.pageContainer}>
        ...
        <div className={loginStyles.formContainer}>
            <form  onSubmit={handleSubmit} className={loginStyles.form} autocomplete="off" noValidate>
                    ...
                    <div className={loginStyles.animatedBorder}>
                        <div className={loginStyles.formContent}>
                            ...
                            <p className={loginStyles.subtitle}>
                                Sign in to continue to Quiz application. Light. Clean UI
                            </p>
