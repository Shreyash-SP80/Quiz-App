...
//   EMAIL, NAME, PASSWORD VALIDATION FUNCTIONS
  const validate = () => {
    const e = {};
  ...
  // Handle submit when user submit form
                ...
                <div className={signupStyles.animatedBorder}>
                    <div className={signupStyles.formContent}>
                        ...
                        <p className={signupStyles.subtitle}>
                            Sign up to continue to Quiz application. Light. Clean UI
                        </p>
                        ...
                        {/* Login link when account already exists */}
