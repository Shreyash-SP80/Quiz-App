...
import { Award, CheckCircle, XCircle, BookOpen, ChevronDown, ChevronRight, Code, Coffee, Cpu, Database, Globe, Menu, Layout, Rss, Sparkles, Star, Target, Terminal, Trophy, X, Zap } from 'lucide-react'
...
const Sidebar = () => {
  ...
  //  if the side bar is open and inner width is less than 768px then it will collapse
  useEffect(() => {
  ...
  // here this function will handle what you select the task
              ...
              <div className={sidebarStyles.logoContainer}>
                ...
                <div>
                  ...
                  <p className={sidebarStyles.logoSubtitle}>
                    Test your Knowladge & Improve Skills
                  </p>
                </div>
              </div>
