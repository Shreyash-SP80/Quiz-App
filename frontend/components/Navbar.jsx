        ...
        <div className={navbarStyles.container}>
            <div className={navbarStyles.logoContainer}>
                <Link to="/" className={navbarStyles.logoButton}>
                    ...
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9G6G_fInAKQNkMKgsz76IPoFtf2kmJdBy0A&s"
                        alt="QuizMaster logo"
            ...
            <div className={navbarStyles.titleContainer}>
                <div className={navbarStyles.titleBackground}>
                    <h1 className={navbarStyles.titleText}>QuizLab Application</h1>
                </div>
            </div>
            ...
            <div className={navbarStyles.mobileMenuContainer}>
                <button onClick={() => setMenueOpen((s) => !s)} className={navbarStyles.menuToggleButton}>
                    {
                        menueOpen? (
                    ...
                    menueOpen && (
                        <div className={navbarStyles.mobileMenuPanel}>
                            <ul className={navbarStyles.mobileMenuList}>
                                <li>
                                    <NavLink to="/result" className={navbarStyles.mobileMenuItem} onClick={() => {
                                        setMenueOpen(false)
                                    }}>
                                ...
                                {loggedIn? (
                                    ...
                                    <li>
                                        <NavLink to='/login' className={navbarStyles.mobileMenuItem} onClick={() => setMenueOpen(false)}>
