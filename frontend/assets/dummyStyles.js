...
export const navbarStyles = {
  // Main nav container
  nav: "w-full bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 shadow-xl py-3 sm:py-4 px-4 sm:px-6 lg:px-10 relative overflow-visible",

  // Decorative pattern
  decorativePattern: "absolute inset-0 opacity-10 pointer-events-none hidden sm:block",
  decorativePatternBackground: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='50' cy='50' r='45' stroke='%234A90E2' stroke-width='4' fill='none'/%3E%3C/svg%3E")`,

  // Floating bubbles
  bubble1: "hidden md:block absolute top-10 left-1/4 w-36 h-36 sm:w-40 sm:h-40 bg-blue-300 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-float-slow",
  bubble2: "hidden lg:block absolute bottom-5 right-20 w-28 h-28 lg:w-32 lg:h-32 bg-blue-400 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-float-slower",
  bubble3: "hidden md:block absolute top-1/3 left-20 w-20 h-20 md:w-24 md:h-24 bg-blue-200 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-float-slowest",
  ...
  // Logo section
  logoContainer: "flex items-center flex-shrink-0",
  logoButton: "inline-flex items-center p-0 bg-transparent rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 transform transition-transform duration-200",
  logoLink: "relative bg-gradient-to-br from-blue-500 to-blue-700 p-0.5 rounded-full",
  logoInner: "bg-gradient-to-b from-blue-800 to-blue-900 p-1 rounded-full",
  logoImage: "h-10 w-10 sm:h-12 sm:w-12 rounded-full object-cover border-2 border-blue-300",

  // Title section
  titleContainer: "flex-1 flex justify-center px-3",
  titleBackground: "bg-gradient-to-r from-blue-200/30 via-blue-300/30 to-blue-200/30 xl:ml-40 backdrop-blur-sm px-4 py-2 sm:px-6 sm:py-3 rounded-full border border-white/10 shadow-md max-w-full",
  titleText: "text-sm sm:text-base md:text-lg lg:text-2xl font-bold font-[pacifico] text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800 text-center truncate",
  ...
  // Button styles
  resultsButton: "inline-flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-medium shadow-md cursor-pointer transform transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400",
  logoutButton: "inline-flex cursor-pointer items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-red-600 to-red-800 text-white text-sm font-medium shadow-md transform transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400",
  loginButton: "inline-flex cursor-pointer items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-blue-400 to-blue-700 text-white text-sm font-medium shadow-md transform transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400",
  buttonIcon: "h-4 w-4 flex-shrink-0",

  // Mobile menu
  mobileMenuContainer: "md:hidden flex items-center",
  menuToggleButton: "inline-flex items-center justify-center p-2 rounded-full bg-white/90 shadow-sm hover:scale-105 transform transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400",
  menuIcon: "h-5 w-5",
  mobileMenuPanel: "absolute right-4 top-full mt-3 w-48 bg-white rounded-lg shadow-lg border z-50 overflow-hidden",
  mobileMenuList: "divide-y",
  mobileMenuItem: "w-full text-left px-4 py-3 flex items-center gap-2 text-sm hover:bg-blue-50",
  mobileMenuIcon: "h-4 w-4",
...
export const resultStyles = {
  ...
  homeButton: `
      inline-flex items-center px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-600
